...
public struct StockPriceInfo{
    ...
    public var preMarketChangePercent:Float?
    ...
    public var preMarketPrice: Float?
    public var quoteType:String?
    public var preMarketSource:String?
    public var preMarketChange:Float?
    ...
    public var regularMarketOpen:Int?
